...
def summarize_text(title, text):
    ...
    try:
        ...
        # Compatibilidade com versões novas da API
...
def handle_link(message):
    ...
    if resultado and resultado.get("text"):
        ...
        bot.edit_message_text(
            ...
            text="🧠 Resumindo conteúdo com Inteligência Artificial..."
        )
        ...
        # proteção contra quebra de HTML
        ...
        bot.edit_message_text(
            chat_id=message.chat.id,
            message_id=msg_status.message_id,
            text="❌ Não foi possível extrair o texto deste link."
        )
